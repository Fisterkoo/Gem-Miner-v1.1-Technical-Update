...
:gameupdating
cls
echo Updating your save file to latest version (1.1)...
set Achievement_Basic1=Dont Own
set Achievement_Basic10=Dont Own
set Achievement_Basic100=Dont Own
set Achievement_Basic1000=Dont Own
set Achievement_Basic10000=Dont Own
set Achievement_Basic100000=Dont Own
set Achievement_Basic1000000=Dont Own
set Achievement_Iron100=Dont Own
set Achievement_Iron1000=Dont Own
set Achievement_Iron10000=Dont Own
set Achievement_Iron100000=Dont Own
set Achievement_Silver100=Dont Own
set Achievement_Silver1000=Dont Own
set Achievement_Silver10000=Dont Own
set Achievement_Silver100000=Dont Own
set Achievement_Gold100=Dont Own
set Achievement_Gold1000=Dont Own
set Achievement_Gold10000=Dont Own
set Achievement_Diamond100=Dont Own
set Achievement_Diamond1000=Dont Own
set Achievement_Diamond10000=Dont Own
set Achievement_Emerald10=Dont Own
set Achievement_Emerald100=Dont Own
set Achievement_Emerald1000=Dont Own
set Achievement_DarkMatter1=Dont Own
set Achievement_DarkMatter10=Dont Own
set Achievement_DarkMatter100=Dont Own
set Achievement_TheBeggining=Dont Own
set Achievement_FirstUpdateWow=Dont Own
set Achievement_Gems1000=Dont Own
set Achievement_Gems10000=Dont Own
set Achievement_Gems100000=Dont Own
set Achievement_Gems1000000=Dont Own
set Achievement_Gems10000000=Dont Own
set Achievement_Gems100000000=Dont Own
set Achievement_Gems1000000000=Dont Own
set Achievement_Time1Min=Dont Own
set Achievement_Time1Hour=Dont Own
set Achievement_Time1Day=Dont Own
set Achievement_Time1Year=Dont Own
set Achievement_Rebirth1=Dont Own
set Achievement_Rebirth10=Dont Own
set Achievement_Rebirth100=Dont Own
set Achievement_Rebirth1000=Dont Own
call :SaveModule
if exist "Gem Miner v1.0.bat" (del "Gem Miner v1.0.bat")
...
echo.
echo.
echo Made By Fisterkoo                     v1.1 Release
...
if !YouTubeCodes! EQU TH3B3GG1N1NG (
	...
	if exist "!cd!\settings\!loguse!code2.bat" (
		cls
		echo You have already redeemed the Code!
		pause
		goto :settings
...
echo.
echo.
echo            Update Gem Miner v1.1 was Downloaded...
echo.
echo             Your current savefile version: 1.0
echo.
echo               Please log into your account to
echo               finish updating your save file
echo                 to newest version... (1.1)
echo.
echo.
echo.
echo.
...
echo.
pause
if exist "!cd!\settings\autologin.bat" (del "!cd!\settings\autologin.bat")
goto :eof
...
if exist "!cd!\settings\!loguse!code1.bat" (set Achievement_TheBeggining=Own)
if exist "!cd!\settings\!loguse!code2.bat" (set Achievement_FirstUpdateWow=Own)
